...
const ListExperience = () => {
    return (
        <section className="my-14 relative max-w-5xl mx-auto overflow-hidden rounded-3xl shadow-md">
            ...
            <div className="max-w-6xl mx-auto rounded-2xl overflow-hidden relative z-10">
                <div className="relative min-h-[250px] flex flex-col-reverse lg:flex-row">
                    {/* Left side - Content */}
                    <div className="w-full lg:w-1/1 p-8 flex flex-col justify-center items-center lg:items-start text-center lg:text-left order-2 lg:order-1">
