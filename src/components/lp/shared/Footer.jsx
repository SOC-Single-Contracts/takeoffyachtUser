           ...
           <h3 className="text-lg font-semibold uppercase">about us</h3>
             <p className="text-gray-600 dark:text-gray-200 text-sm">Jennys bilge blimey cutlass seas o'nine on. Sail lass coffer yarr gangway fluke bucko buccaneer killick.</p>
              <div className="flex items-center gap-2">
                <Image alt="Google Play" className="cursor-pointer w-full max-w-[120px]" width={120} height={50} src="/assets/images/googleplay.png" quality={100} />
                <Image alt="App Store" className="cursor-pointer w-full max-w-[120px]" width={120} height={50} src="/assets/images/applyappstore.png" quality={100} />
                </div>
         </div>
