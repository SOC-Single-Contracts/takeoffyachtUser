...
const EmblaCarouselExperience = (props) => {
  const { slides, options, experienceType, item, daysCount, handleWishlistToggle, favorites } = props
  ...
  return (
   ...
   {experienceType == "f1-exp" &&   <Image src="/assets/images/redtag.png" alt="Hot" width={50} height={50} className="absolute top-0 right-0 z-10" />} 
...
export default EmblaCarouselExperience
