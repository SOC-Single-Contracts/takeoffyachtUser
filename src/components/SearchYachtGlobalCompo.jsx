...
const SearchYachtGlobalCompo = () => {
  ...
  useEffect(() => {
    ...
    if (currentPath === targetPath) {
      ...
      let value = `/dashboard/${yachtsType == "f1yachts" ? "f1yachts" : "yachts"}`;
      setSearchPath(value)
                ...
                <SheetContent side="left" className="w-full sm:w-[540px]">
                  ...
                  <ScrollArea className="h-[calc(100vh-80px)] px-2">
                    ...
                    <div className="space-y-6 py-6 px-1">
                      {/* Price Range */}
                      <div className="space-y-2">
                        <Label className="text-sm"> {yachtsType == "yachts" ? "Price Per Hour (AED) " : yachtsType == "f1yachts" ? "Price (AED) " : ""}</Label>
...
export default SearchYachtGlobalCompo;
