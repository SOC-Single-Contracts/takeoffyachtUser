...
const SearchEventGlobalCompo = ({ limit }) => {
    ...
    const [componentType, setcomponentType] = useState("simpleEvents")
    const targetPath = `/dashboard/events/search`;
    const [searchPath, setSearchPath] = useState(`/dashboard/events`)
    ...
    const handleResetAll = async () => {
        ...
        let payloadHardReset = {
            source: componentType == "searchEvents" ? "searchEvents" : componentType == "simpleEvents" ? "simpleEvents" : "",
        ...
        try {
            ...
            const responseData = await yachtApi.checkEvents(payloadHardReset);
    ...
    useEffect(() => {
        ...
        let obj = {
            ...
            eventdb_id: searchParams.get('eventdb_id') || "",
    ...
    const handlePagination = async () => {
        ...
        try {
            ...
            const responseData = await yachtApi.checkEvents(payload);
            if (responseData.error_code === 'pass') {
                let filteredEvents = responseData.data || [];
    ...
    useEffect(() => {
        ...
        if (currentPath === targetPath) {
            let value = `/dashboard/events/search`;
            setSearchPath(value)
            setcomponentType("searchEvents")
        } else {
            let value = `/dashboard/events`;
            setSearchPath(value)
            setcomponentType("simpleEvents")
    ...
    //     useEffect(()=>{
    //    console.log(componentType,searchPath)
    //     },[])
