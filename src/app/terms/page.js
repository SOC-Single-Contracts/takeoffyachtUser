...
const TermsContent = () => {
  return (
    <div className="max-w-5xl mx-auto mt-28 px-4 py-8">
      <h1 className="text-4xl font-bold mb-6">Terms and Conditions</h1>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">1. Introduction</h2>
        <p className=" mb-4">
          Welcome to Take Off Yachts ("Company", "we", "our", "us"). These Terms and Conditions ("Terms") govern your use of our website located at [yourwebsite.com] ("Service"). Please read these Terms carefully before using our Service.
        </p>
        <p className="">
      ...
      <section className="mb-8">
        ...
        <p className=" mb-4">
          All bookings are subject to availability and confirmation by us. We reserve the right to refuse booking requests at our discretion.
        </p>
        <p className="">
          Payment terms, cancellation policies, and refund procedures are outlined in our Booking Policy, which is incorporated into these Terms by reference.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside  mb-4">
          ...
          <li>Solicit others to perform or participate in any unlawful acts.</li>
          <li>Intentionally transmit any harmful computer code, files, or programs.</li>
      ...
      <section className="mb-8">
        ...
        <p className="">
          The Service and its original content, features, and functionality are and will remain the exclusive property of Take Off Yachts and its licensors. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Take Off Yachts.
        </p>
      </section>
