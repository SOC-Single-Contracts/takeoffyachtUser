...
const YachtDetail = () => {
  ...
  useEffect(() => {
    ...
    const getYachts = async () => {
      ...
      try {
        ...
        // const allYachtIds = newData?.map(item => item?.experience?.id).filter(id => id !== undefined);

        // console.log("All Yacht IDs:", allYachtIds);
        // console.log("yacht", yacht, newData, id);
        // const yachtWithId8 = newData?.find(item => item?.experience?.id === 8);
  ...
  const yachtImages = [
    ...
    selectedYacht?.experience?.image4,
    selectedYacht?.experience?.image5,
    selectedYacht?.experience?.image6,
    selectedYacht?.experience?.image7,
    selectedYacht?.experience?.image8,
    selectedYacht?.experience?.image9,
    selectedYacht?.experience?.image10,
    selectedYacht?.experience?.image11,
    selectedYacht?.experience?.image12,
    selectedYacht?.experience?.image13,
    selectedYacht?.experience?.image14,
    selectedYacht?.experience?.image15,
    selectedYacht?.experience?.image16,
    selectedYacht?.experience?.image17,
    selectedYacht?.experience?.image18,
    selectedYacht?.experience?.image19,
    selectedYacht?.experience?.image20,
  ].filter(Boolean);
  ...
  const uniqueYachtImages = [...new Set([selectedYacht?.experience?.yacht_image, ...yachtImages])].filter(Boolean);
  ...
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row -mx-4">
            ...
            <div className="w-full md:w-2/2 lg:w-2/4 px-2">
              ...
              <div className="flex justify-between items-center mt-2">
                ...
                {experienceType == "regular-exp" ? <p className="text-gray-600 dark:text-gray-400">AED <span className="text-xl font-bold !text-black dark:!text-white">{per_hour_price}</span>/hour</p> : experienceType == "f1-exp" ? <p className="text-gray-600 dark:text-gray-400">AED
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-3">
                {getYachtDetailsGrid(selectedYacht?.experience)}
              ...
              <div className="flex justify-between flex-wrap items-center gap-2 my-4">
                ...
                <Link className="hidden md:block" href={session ? `/dashboard/experience/${experienceType}/${id}/booking` : `/dashboard/experience/${experienceType}/${id}/booking`}>
                  <Button
                    // onClick={(e) => {
                    //   if (!session) {
                    //     e.preventDefault();
              ...
              <Accordion className="space-y-4" type="multiple" collapsible>
                ...
                <AccordionItem className="" value="item-2">
                  ...
                  <AccordionContent className="mt-4">
                    ...
                    {capacity &&   <div className="flex justify-between items-center h-10 px-4 py-2 bg-[#F1F1F1] dark:bg-gray-800 rounded-lg mt-2 font-medium">
                   ...
                   {number_of_cabin &&   <div className="flex justify-between items-center h-10 px-4 py-2 bg-[#F1F1F1] dark:bg-gray-800 rounded-lg mt-2 font-medium">
                      <p className="text-gray-700 dark:text-gray-400 font-normal text-sm">
                        Number of Cabins
                      </p>
                      <p className="text-gray-700 dark:text-gray-400 font-normal text-sm">
              ...
              {experienceType !== "f1-exp" && ny_status && ((ny_start_time && ny_end_time) || ny_price || ny_firework) && (
                <section className="mt-4">
                  <h2 className="text-lg font-medium">
                    New Year's Eve
                  </h2>
              ...
              <section className="mt-4">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {/* {console.log("selectedYacht?.experience?.features",selectedYacht?.experience?.features,selectedYacht?.experience?)} */}
                  {selectedYacht?.experience?.features && selectedYacht?.experience?.features.length > 0 ? (
                    selectedYacht?.experience?.features.map((feature, index) => (
              ...
              <div className="my-5">
                ...
                {(longitude || latitude) && (
                  <>
                    ...
                    <MapBoxComponent
                      markers={[
                        { latitude, longitude, yacht: selectedYacht?.experience, experienceType },
      ...
      <section className="">
        {experienceType == "f1-exp" ? <FormulaOneDashboard /> : <Featured />}
      ...
      <div className="fixed md:hidden bottom-0 left-0 w-full  shadow-md z-50 p-4">
        <div className="relative  flex justify-center">
          <Link className="w-full" href={session ? `/dashboard/experience/${experienceType}/${id}/booking` : `/dashboard/experience/${experienceType}/${id}/guest-booking`}>
            <Button
